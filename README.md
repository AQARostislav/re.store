...
<a href="https://selenide.org/"><img src="images/icons/selenide.svg" width="55" height="55"  alt="Selenide"/></a>
<a href="https://aerokube.com/selenoid/"><img src="images/icons/selenoid.svg" width="70" height="70"  alt="Selenoid"/></a>
<a href="https://github.com/allure-framework/allure2"><img src="images/icons/allure.png" width="50" height="60"  alt="Allure"/></a>
...
<a href="https://www.atlassian.com/ru/software/jira/"><img src="images/icons/jira.svg" width="70" height="70"  alt="Jira"/></a>  
</p>
...
В данном проекте сборка выполняется автоматически каждые 5 часов.
<p align="center">
...
- локальный запуск(localhost:8080/)
...
<p align="center">  
<img title="Allure Overview Dashboard" src="images/screenshots/allure.jpg" width="850">  
</p>
...
<a id="telegram"></a>
## <img alt="Allure" height="25" src="images/icons/telegram.png" width="25"/></a> Интеграция с Telegram. Автоматические уведомления о сборке
Настроены автоматические уведомления в Telegram для получения информации о статусе сборки и тестирования.

<p align="center">  
<img title="Allure Overview Dashboard" src="images/screenshots/telergam.png" width="550">  
</p>

<a id="video"></a>
### Видеозапись выполнения тестов
Помогают визуально проверять, как проходят тесты и выявлять проблемы.

<p align="center">
<img title="Selenoid Video" src="images/video/videotests.gif" width="550" height="350"  alt="video">   
</p>

<a id="other"></a>
### Плагины
- **java-library**: Плагин для работы с Java библиотеками.
- **io.qameta.allure (версия 3.0.1)**: Плагин для интеграции с Allure для генерации отчетов.
...
- **JUnit 5 (версия 5.13.4)**: Фреймворк для модульного тестирования на Java.
- **Allure Selenide (версия 2.29.0)**: Для интеграции Selenide с Allure для детализированных отчетов.
- **SLF4J Simple (версия 2.0.16)**: Простая фасадная библиотека для логирования в Java.
